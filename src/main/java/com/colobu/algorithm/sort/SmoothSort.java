...
public class SmoothSort implements ISort
{
	...
	private static <T extends Comparable<? super T>> void sift(T[] source, int pshift, int head)
	{
	...
	private static <T extends Comparable<? super T>> void trinkle(T[] source, int p, int pshift, int head, boolean isTrusty)
	{
